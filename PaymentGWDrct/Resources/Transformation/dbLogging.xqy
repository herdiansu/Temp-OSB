...
declare namespace ns1="http://xmlns.oracle.com/pcbpel/adapter/db/dbLogging";
(:: import schema at "../Adapter/dbLogging.xsd" ::)
...
declare function local:func($createdDate as xs:date, 
                            ...
                            as element() (:: schema-element(ns1:dbLoggingInput) ::) {
    <ns1:dbLoggingInput>
